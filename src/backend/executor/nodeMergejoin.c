...
/*
 * Include the header for incremental processing
 * */
...
ExecInitMergeJoin(MergeJoin *node, EState *estate, int eflags)
{
    ...
    /*
     * totem: add incremental option
     */
    if (estate->es_incremental) 
    {
        mergestate->js.ps.ExecProcNode = ExecMergeJoinInc;
        ExecInitMergeJoinInc(mergestate);
    } 
    else
    ...
    /*
     * totem: we need REWIND flag for incremental query processing
     */
